/**
* @file        hmac_sha256.h
* @brief       This file contains all the functions prototypes for the HMAC SHA256 firmware library. 
 ...
 * @definitions
***************************************************************************************************/
/** @defgroup HMAC_SHA256_Exported_Types HMAC SHA256 Exported Types
  * @{
  */
...
/** @defgroup HMAC_SHA256_Exported_Constants HMAC SHA256 Exported Constants
  * @{
  */
 ...
 * @functions
***************************************************************************************************/
/** @defgroup HMAC_SHA256_Exported_Functions HMAC SHA256 Exported Functions
  * @{
  */
...
/**
  ...
  * @param  ctx: input, HMAC_SHA256_CTX context pointer.
  * @param  key: input, key.
...
/**
  ...
  * @param  ctx: input, HMAC_SHA256_DMA_CTX context pointer.
  * @param  key: input, key.
  * @param  sp_key_idx: input, index of secure port key.
...
/**
  ...
  * @param  ctx: input, HMAC_SHA256_DMA_CTX context pointer.
  * @param  msg: input, message.
  * @param  msg_words: input, word length of the input message, must be a multiple of block word length of SHA256(16).
  * @note   Please make sure the parameters are valid, and ctx is initialized.
  * @return HASH_SUCCESS(success), other(error).
  */
