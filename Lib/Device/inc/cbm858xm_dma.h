...
* <tr><td>2022.05.17    <td>1.0.0      <td>ChipSea    <td>
* -# 
* </table>
*
****************************************************************************************************
...
#ifndef __CBM858xM_DMA_H__
#define __CBM858xM_DMA_H__
...
/** @defgroup DMA_data_transfer DMA data transfer direction 
  * @{
  */
...
/** @defgroup DMA_peripheral_increment DMA peripheral increment enable defintion
  * @{
  */
...
/** @defgroup DMA_memory_increment DMA memory increment enable defintion
  * @{
  */
...
/** @defgroup DMA_peripheral_data_width DMA peripheral data width defintion
  * @{
  */
...
/** @defgroup DMA_memory_data_width DMA memory data width defintion
  * @{
  */
...
/** @defgroup DMA_operation_mode DMA operation mode defintion
  * @{
  */
...
/** @defgroup DMA_channel_priority DMA channel priority defintion
  * @{
  */
...
/** @defgroup DMA_memory_to_memory_mode DMA memory_to_memory mode  defintion
  * @{
  */
...
/*! DMA buffer size check definition */
#define DMA_BUFFER_SIZE_CHECK(size)             (((size) >= 0x1) && ((size) < 0x10000))

/*! DMA check definition */
#define DMA_BUS_CHECK(dma)                      ((dma) == DMA1)

/** @defgroup DMA_interrupt DMA interrupt enable definition
  * @{
  */
...
/** @defgroup DMA_flags DMA flags definition
  * @{
  */
...
/**
  ...
  * @param  CHx: DMA channelx,it can be DMA1_CHANNELx, where x can be 1,2,3,4,5
...
/**
  ...
  * @param  ptr_chx: DMA channelx,it can be DMA1_CHANNELx, where x can be 1,2,3,4,5
  * @return None
  */
