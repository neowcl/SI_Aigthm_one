...
* <tr><td>2022.05.13    <td>1.0.0      <td>ChipSea    <td>
* -# 
* </table>
*
****************************************************************************************************
...
#ifndef __CBM858xM_TIM_H__
#define __CBM858xM_TIM_H__
...
/*! check all TIMx(1,3,14) definition */
#define TIM_ALL_TIMx_CHECK(value) 				(((value) == TIM1) || ((value) == TIM3)  || ((value) == TIM14)) 

/*! check list1 TIM1 definition */
#define TIM_LIST1_TIMx_CHECK(value)  			((value) == TIM1)

/*! check list2 TIM1 definition */
#define TIM_LIST2_TIMx_CHECK(value)  			(((value) == TIM1)|| ((value) == TIM3))
/**
  * @}
  */

/** @defgroup Timer_channel Timer channel definition 
  * @{
  */
#define TIM_CHANNEL_1							((uint8_t)0x00)		/*!< Specifies the TIMx channel 1, for TIM1/3/14 */
#define TIM_CHANNEL_2							((uint8_t)0x01)		/*!< Specifies the TIMx channel 2, for TIM1/3 */ 
#define TIM_CHANNEL_3							((uint8_t)0x02)		/*!< Specifies the TIMx channel 3, for TIM1/3 */
#define TIM_CHANNEL_4							((uint8_t)0x03)		/*!< Specifies the TIMx channel 4, for TIM1/3 */
/**
  * @}
  */
...
/** @defgroup Timer_forced_active Timer Channel x output compare mode selection(forced active) definition
  * @{
  */
...
/** @defgroup Timer_Channelx_mode Timer Channelx output compare mode selection definition
  * @{
  */
...
/** @defgroup Timer_Single_pulse_mode Timer Single pulse  mode definition
  * @{
  */
...
/** @defgroup Timer_Clock_Division_CKD Timer clock division CKD definition
  * @{
  */
...
/** @defgroup Timer_count_pattern Timer count pattern definition
  * @{
  */
...
/** @defgroup Timer_CHxCCP_polarity Timer channelx capture compare polarity definition
  * @{
  */
...
/**
  * @}
  */
#define TIM_CHxCCP_POLARITY_CHECK(polarity) 	(((polarity) == TIM_CHxCCP_POLARITY_HIGH) || TIM_CHxCCP_POLARITY_LOW

/** @defgroup Timer_CHxNCCP_polarity Timer channelx complementary capture compare  polarity definition
  * @{
  */
...
/** @defgroup Timer_channel_output_compare_state Timer channel output compare state definition
  * @{
  */
...
/** @defgroup Timer_CHxNCCEN Timer CHxNCCEN (channel complementary capture compare enable) definition
  * @{
  */
...
/** @defgroup Timer_CHxCC Timer channelx capture compare state definition
  * @{
  */
...
/** @defgroup Timer_CHxNCC Timer channelx complementary capture compare state definition
  * @{
  */
...
/** @defgroup Timer_BREAK Timer Break input enable/disable definition
  * @{
  */
...
/** @defgroup Timer_BREAK_POLARITY Timer Break Polarity definition
  * @{
  */
...
/**
  * @}
  */
#define TIM_BREAK_POLARITY_CHECK(flag) 			(((flag) == TIM_BREAK_POLARITY_LOW) || TIM_BREAK_POLARITY_HIGH

/** @defgroup Timer_CHOPAEN Timer CHOPAEN(Channel output pad auto enable) definition
  * @{
  */
...
/** @defgroup Timer_lock_level Timer lock level control definition
  * @{
  */
...
/** @defgroup Timer_IDLEOS Timer Idle mode off-state control definition
  * @{
  */
...
/** @defgroup Timer_RUNOS Timer Run mode off-state control definition
  * @{
  */
...
/** @defgroup Timer_IVOx Timer IVOx (Idle value output of channelx) definition 
  * @{
  */
#define TIM_IVOx_SET                			((uint16_t)0x0100) /*!< Set idle output value of channelx compare */
#define TIM_IVOx_RESET              			((uint16_t)0x0000) /*!< Reset idle output value of channelx compare */
/**
  * @}
  */
#define TIM_IVOx_CHECK(flag) 					(((flag) == TIM_IVOx_SET) || ((flag) == TIM_IVOx_RESET)) 

/** @defgroup Timer_IVOxN Timer IVOxN (Idle value output of channelx complementary)  definition
  * @{
  */
...
/** @defgroup Timer_CHxIC_POLARITY Timer channel input capture polarity definition
  * @{
  */
...
/** @defgroup Timer_CHIC_SEL Timer channel Input Capture Selection definition 
  * @{
  */
...
/** @defgroup Timer_CHIC_PREDIVIDE Timer channel Input Capture pre-divide definition 
  * @{
  */
...
/** @defgroup Timer_EVENT_SOURCE Timer interrupt Event Source definition
  * @{
  */
...
/** @defgroup Timer_DMA_base_address Timer DMA base address definition
  * @{
  */
...
/** @defgroup Timer_DMA_transfer_length Timer DMA transfer length definition
  * @{
  */
...
/** @defgroup Timer_DMA_source Timer DMA source definition
  * @{
  */
...
/** @defgroup Timer_external_trigger_pre-divide Timer external trigger pre-divide definition
  * @{
  */
...
/** @defgroup Timer_trigger_selection Timer internal trigger selection definition
  * @{
  */
...
/** @defgroup Timer_External_Clock_Source Timer External Clock Source definition
  * @{
  */
#define TIM_TIMx_EXTICLK1_SOURCE_TI1ED			((uint16_t)0x0040) /*!< TI1 edge detecting */
#define TIM_TIMx_EXTICLK1_SOURCE_TI1      		((uint16_t)0x0050) /*!< Filtered timer input 1 */
#define TIM_TIMx_EXTICLK1_SOURCE_TI2      		((uint16_t)0x0060) /*!< Filtered timer input 2 */
/**
  * @}
  */

/** @defgroup Timer_external_trigger_polarity Timer external trigger polarity definition
  * @{
  */
...
/** @defgroup Timer_pre-divider_mode Timer pre-divider reload mode definition
  * @{
  */
...
/** @defgroup Timer_Encoder_mode Timer Encoder mode definition 
  * @{
  */
...
/** @defgroup Timer_update_selection Timer update request selection definition
  * @{
  */
...
/** @defgroup Timer_CHxOC_preload Timer CHxOC(channelx output compare) preload enable definition
  * @{
  */
...
/** @defgroup Timer_CHxOC_Fast Timer CHxOC(channelx output compare) Fast enable definition 
  * @{
  */
...
/** @defgroup Timer_CHxOC_Clear Timer CHxOC(channelx output compare) Clear enable definition 
  * @{
  */
...
/** @defgroup Timer_Trigger_output Timer Trigger output source definition
  * @{
  */
...
/** @defgroup Timer_slave_mode Timer slave mode definition
  * @{
  */
...
/** @defgroup Timer_Master_slave_mode Timer Master Slave Mode definition
  * @{
  */
...
/*! check TIM channel input capture filer value */
...
/** @defgroup Timer_OCREF_Clear Timer OCREF Clear definition
  * @{
  */
...
/** @defgroup TIM14_remap TIM14 remap definition
  * @{
  */
...
#define TIM14_REMAP_CHECK(value) 				(((value) == TIM14_REMAP_PORT)		|| \
                                  				...
                                  				((value) == TIM14_REMAP_HXT_DIV2048) 	|| \
                                  				((value) == TIM14_REMAP_MCO))                                 

/** @defgroup Timer_interrupt_ Timer interrupt sources definition
  * @{
  */
...
/** @defgroup Timer_Flag Timer Flag definition
  * @{
  */
...
/** @defgroup Timer_Register Timer register definition
  * @{
  */
...
/** @defgroup Timer_bit_enable Timer function enable registers definition
  * @{
  */
...
/** @defgroup Timer_interrupt_enable Timer interrupt enable bits definition
  * @{
  */
...
/**
  ...
  * @param	TIMx: pointer to TIMx where x can be 1, 3, or 14.
  * @return None
  */
...
/**
  ...
  *			 @arg TIM_CHANNEL_1: TIM channel 1, for TIM1/3/14.
  *			 @arg TIM_CHANNEL_2: TIM channel 2, for TIM1/3.  
  *			 @arg TIM_CHANNEL_3: TIM channel 3, for TIM1/3. 
  *			 @arg TIM_CHANNEL_4: TIM channel 4, for TIM1/3.  
...
/**
  ...
  *          @arg TIM_EVENT_SOURCE_UPDATE(TIM update Interrupt Event source, for TIM1/3/14)
  *          @arg TIM_EVENT_SOURCE_CH1 (TIMx channel 1 Capture Compare Interrupt Event, for TIM1/3/14)
  *          @arg TIM_EVENT_SOURCE_CH2 (TIMx channel 2 Capture Compare Interrupt Event, for TIM1/3)
  *          @arg TIM_EVENT_SOURCE_CH3 (TIMx channel 3 Capture Compare Interrupt Event, for TIM1/3)
  *          @arg TIM_EVENT_SOURCE_CH4 (TIMx channel 4 Capture Compare Interrupt Event, for TIM1/3)
  *          @arg TIM_EVENT_SOURCE_COM (TIMx Commutation Interrupt Event source, for TIM1)
  *          @arg TIM_EVENT_SOURCE_TRIGGER (TIMx Trigger Interrupt Event source, for TIM1/3) 
  *          @arg TIM_EVENT_SOURCE_BREAK (TIMx Break Interrupt Event source, TIM1)         
  * @return None
  */
...
/**
  ...
  * @param  TIMx: pointer to TIMx where x can be 1,3.
  * @param  FUNC: specifies the TIM function.
  *         It can be one of the following values:
  *          @arg PRELOAD_SHADOW (TIM1)
  *          @arg PRELOAD_UPDATE TIM1)
  *          @arg UPDATE_DIS (TIM1/3)
  *          @arg UVAL_SHADOW (TIM1/3)
  *          @arg CH_OUTPUT (TIM1)
  *          @arg DMA_REQUEST (TIM1/3)
  *          @arg XOR_INPUT (TIM1/3)
  * @return None
  */
...
/**
  ...
  *          @arg TIM_DMA_CH1CC (TIMx channel 1 Capture Compare DMA)
  *          @arg TIM_DMA_CH2CC (TIMx channel 2 Capture Compare DMA)
  *          @arg TIM_DMA_CH3CC (TIMx channel 3 Capture Compare DMA)
  *          @arg TIM_DMA_CH4CC (TIMx channel 4 Capture Compare DMA)
...
/**
  ...
  *           @arg TIM_INTR_UPDATE(TIM update Interrupt source, for TIM1/3/14)
  *           @arg TIM_INTR_CH1CC (TIMx channel 1 Capture Compare Interrupt, for TIM1/3/14)
  *           @arg TIM_INTR_CH2CC (TIMx channel 2 Capture Compare Interrupt, for TIM1/3)
  *           @arg TIM_INTR_CH3CC (TIMx channel 3 Capture Compare Interrupt, for TIM1/3)
  *           @arg TIM_INTR_CH4CC (TIMx channel 4 Capture Compare Interrupt, for TIM1/3)
  *           @arg TIM_INTR_CHCOM (TIMx Commutation Interrupt source, for TIM1)
  *           @arg TIM_INTR_TRIGGER (TIM Trigger Interrupt source, for TIM1/3)
  *           @arg TIM_INTR_BREAK (TIM Break Interrupt source, for TIM1) 
  * @return None
  */
...
/**
  ...
  *			It can be one of the following values:
  *          @arg UPDATE (TIMx update Interrupt source, for  TIM1/3/14)
  *          @arg CH1CC  (TIMx channel 1 Capture Compare Interrupt, for  TIM1/3/14)
  *          @arg CH2CC  (TIMx channel 2 Capture Compare Interrupt, forTIM1/3)
  *          @arg CH3CC  (TIMx channel 3 Capture Compare Interrupt, for TIM1/3)
  *          @arg CH4CC  (TIMx channel 4 Capture Compare Interrupt, for TIM1/3)
  *          @arg CHCOM  (TIMx Commutation Interrupt source, for TIM1)
  *          @arg TRIGGER (TIMx Trigger Interrupt source, for TIM1/3) 
  *          @arg BREAK (TIMx Break Interrupt source, for TIM1)
  * @return SET or RESET.
  */
...
/**
  ...
  *          @arg UPDATE (TIMx update Flag, for TIM1/3/14)
  *          @arg CH1CC (TIMx chnnel 1 Capture Compare Flag, for TIM1/3/14)
  *          @arg CH2CC (TIMx chnnel 2 Capture Compare Flag, for TIM1/3)
  *          @arg CH3CC (TIMx chnnel 3 Capture Compare Flag, for TIM1/3)
  *          @arg CH4CC (TIMx chnnel 4 Capture Compare Flag, for TIM1/3)
  *          @arg CHCOM (TIMx Commutation Flag, for TIM1)
  *          @arg TRIGGER (TIMx Trigger Flag, for TIM1/3)
  *          @arg BREAK (TIMx Break Flag, for TIM1)
  *          @arg CH1ICOF (TIMx chnnel 1 Capture Compare overflow Flag, for TIM1/3/14)
  *          @arg CH2ICOF (TIMx chnnel 2 Capture Compare overflow Flag, for TIM1/3)
  *          @arg CH3ICOF (TIMx chnnel 3 Capture Compare overflow Flag, for TIM1/3)
  *          @arg CH4ICOF (TIMx chnnel 4 Capture Compare overflow Flag, for TIM1/3)
  * @return SET or RESET.
  */
...
/**
  ...
  * @param	TIMx: pointer to TIMx where x can be 1, 3, or 14.  
  * @param  FLAG: specifies the flag to check,it can be one of the following values:
  *          @arg TIM_FLAG_UPDATE (TIMx update Flag, for TIM1/3/14)
  *          @arg TIM_FLAG_CH1CC (TIMx chnnel 1Capture Compare Flag, forTIM1/3/14)
  *          @arg TIM_FLAG_CH2CC (TIMx chnnel 2Capture Compare Flag, for TIM1/3)
  *          @arg TIM_FLAG_CH3CC (TIMx chnnel 3Capture Compare Flag, for TIM1/3)
  *          @arg TIM_FLAG_CH4CC (TIMx chnnel 4Capture Compare Flag, for TIM1/3)
  *          @arg TIM_FLAG_CHCOM (TIMx Commutation Flag, for TIM1)
  *          @arg TIM_FLAG_TRIGGER (TIMx Trigger Flag, for TIM1/3)
  *          @arg TIM_FLAG_BREAK (TIM Break Flag, for TIM1)
  *          @arg TIM_FLAG_CH1ICOF (TIMx chnnel 1 Capture Compare overflow Flag, for TIM1/3/14)
  *          @arg TIM_FLAG_CH2ICOF (TIMx chnnel 2 Capture Compare overflow Flag, for TIM1/3)
  *          @arg TIM_FLAG_CH3ICOF (TIMx chnnel 3 Capture Compare overflow Flag, for TIM1/3)
  *          @arg TIM_FLAG_CH4ICOF (TIMx chnnel 4 Capture Compare overflow Flag, for TIM1/3)
  * @return None
  */
...
/**
  ...
  * @param  ptr_timer: pointer to TIMx where x can be 1, 3 or 14.
...
/**
  ...
  * @param  ptr_timer: pointer to TIMx where x can be 1 or 3.
...
/**
  ...
  *          @arg TIM_UPDATE_SEL_GLOBAL (Source of update is the counter overrun/underrun or
  *               the setting of UG bit, or an update generation through the slave mode controller)
  *          @arg TIM_UPDATE_SEL_REGULAR (Source of update is counter overflow/underflow)
  * @return None
  */
...
/**
  ...
  * @param  ptr_timer: pointer to TIMx where x only can be 1.   
...
/**
  ...
  * @param  ch: specifies the channel.
  * 		It can be one of the following values:
  *			 @arg TIM_CHANNEL_1: TIM channel 1, only for TIM1, 3, 14.
  *			 @arg TIM_CHANNEL_2: TIM channel 2, only for TIM1, 3.  
  *			 @arg TIM_CHANNEL_3: TIM channel 3, only for TIM1, 3. 
  *			 @arg TIM_CHANNEL_4: TIM channel 4, only for TIM1, 3.    
...
/**
  * @brief  Enables or disables the TIMx CHxOC(channel 1~4 output compare) Preload value.
  * @param  ptr_timer: pointer to TIMx where x can be 1, 3 or 14. 
  * @param  ch: specifies the channel.
  * 		It can be one of the following values:
  *			 @arg TIM_CHANNEL_1: TIM channel 1, only for TIM1, 3, 14.
...
/**
  * @brief  Set the TIMx CHxOC(channel 1~4 Output Compare) Fast feature.
  * @param  ptr_timer: pointer to TIMx where x can be 1, 3 or 14. 
  * @param  ch: specifies the channel.
  * 		It can be one of the following values:
  *			 @arg TIM_CHANNEL_1: TIM channel 1, only for TIM1, 3, 14.
...
/**
  * @brief  Clears or safeguards the TIMx CHxOC(channel 1~4 Output Compare) signal on an external event.
  * @param  ptr_timer: pointer to TIMx where x can be 1 or 3. 
  * @param  ch: specifies the channel.
  * 		It can be one of the following values:
  *			 @arg TIM_CHANNEL_1: TIM channel 1, only for TIM1, 3.
  *			 @arg TIM_CHANNEL_2: TIM channel 2, only for TIM1, 3.  
  *			 @arg TIM_CHANNEL_3: TIM channel 3, only for TIM1, 3. 
  *			 @arg TIM_CHANNEL_4: TIM channel 4, only for TIM1, 3.     
...
/**
  ...
  * @param  ptr_timer: pointer to TIMx where x can be 1,3,14.
  * @param  ch: specifies the channel.
  * 		It can be one of the following values:
  *			 @arg TIM_CHANNEL_1: TIM channel 1(TIM1/3/14).
  *			 @arg TIM_CHANNEL_2: TIM channel 2(TIM1/3).  
  *			 @arg TIM_CHANNEL_3: TIM channel 3(TIM1/3).
  *			 @arg TIM_CHANNEL_4: TIM channel 4(TIM3).
  * @param  value: specifies the Polarity, It can be one of the following values:
...
/**
  ...
  * @param  ptr_timer: pointer to TIMx where x can be 1, 3.    
...
/**
  * @brief  Sets the TIMx CHxIC (channel 1~4 Input Capture) pre-divide.
  * @param  ptr_timer: pointer to TIMx where x can be 1, 3 or 14.
  * @param  ch: specifies the channel.
  * 		It can be one of the following values:
  *			 @arg TIM_CHANNEL_1: TIM channel 1, only for TIM1, 3, 14.
...
/**
  ...
  * @param  ptr_timer: pointer to TIMx where x can be 1, 3.   
  * @param  value: Trigger source,it can be one of the following values:
  *          @arg TIM_TIMx_EXTICLK1_SOURCE_TI1ED (TI1 Edge Detector)
  *          @arg TIM_TIMx_EXTICLK1_SOURCE_TI1 (Filtered Timer Input 1)
  *          @arg TIM_TIMx_EXTICLK1_SOURCE_TI2 (Filtered Timer Input 2)
