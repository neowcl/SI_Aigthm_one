/**
* @file        cbm858xm_i2c.c
* @brief       This file provides all the basic i2c firmware functions.
...
/** 
  ...
  */
#define I2C_CTR2_CLEAR_MASK     ((uint32_t)0x07FFFFFF)
...
void i2c_init(i2c_reg_t* ptr_i2c, i2c_config_t* ptr_struct)
{
    ...
    MODIFY_REG(ptr_i2c->CTR1, (I2C_CTR1_DFCFG | I2C_CTR1_AFDIS), ptr_struct->analog_flag | \
               (ptr_struct->digital_value << 8));
    ...
    MODIFY_REG(ptr_i2c->SADR1, (I2C_SADR1_SADR1EN | I2C_SADR1_SADR1 | I2C_SADR1_SADR1MODE), ptr_struct->ack_addr | \
               ptr_struct->slave_addr1);
